...
insert into songs (slug, title, composer, description, genre, language, youtube_url, video_embed_url, thumbnail_url, featured) values
  ...
  ('sharanam-hindi',       'Sharanam',         'Music Instincts', 'A devotional composition in Hindi, an offering of surrender and peace.',                               'spiritual',    'hindi',    'https://youtu.be/3qH6La5daLI',  'https://www.youtube.com/embed/3qH6La5daLI',  'https://img.youtube.com/vi/3qH6La5daLI/hqdefault.jpg',      true),
  ...
  ('thalapathi-tamil',     'Thalapathi',       'Music Instincts', 'A powerful Tamil film composition that captures the spirit of a legend.',                              'filmy',        'tamil',    'https://youtu.be/mcXB0G5Diq4',  'https://www.youtube.com/embed/mcXB0G5Diq4',  'https://img.youtube.com/vi/mcXB0G5Diq4/hqdefault.jpg',      false),
