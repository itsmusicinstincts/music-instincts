# Karma, Maya & the Nine Rasas — Story One-Pager

*A comical, theatrical stage show — live dance, Bollywood song snippets, video backdrop, and a social message, built around the ancient Navras (nine emotions).*
...
- **Comic, warm, never preachy.** Karma Dev is a playful trickster (terrible puns, deep wisdom underneath), not a punishing god.
- **"Jaisi Karni, Waisi Bharni"** ("as you sow, so you reap") — consequences shown immediately and visibly, for laughs and for feeling, not lectures.
- Underlying message: **an AI can learn to imitate every human expression — but karma (conscience, consequence, connection) is what actually makes those expressions mean something.** The same nine emotions that build people up can also turn them toward their worst selves ("Rakshash level") — humans need to actively choose which side they lean into. A machine can only borrow the shape of the feeling, not the choice behind it.
...
- **Songs:** Bollywood snippets for comedy, romance, and dance (*Hawa Ke Saath Saath*, *Yeh Ladka Hai Deewana*, *Kuch Kuch Hota Hai* / *Main Hoon Na*, *Yeh Bandhan Toh Pyaar Ka Bandhan Hai*, a qawwali number, a Veer Ras anthem, plus an original Karma hook song and closing "Emote 2.0" finale song).
- **Visuals:** Live stage + video backdrop throughout; Maya's look evolves as she learns (see production docs for the current visual system).
- **Costumes:** Bright, colour-coded by rasa.
